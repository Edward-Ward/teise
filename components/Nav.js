...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-gray-500 font-medium'>
      ...
      <div className={nav ? 'fixed flex flex-col text-2xl justify-center gap-60 items-center inset-0 w-[100%] h-full bg-gray-700 ease-in-out duration-500 text-white' : 'ease-in-out duration-500 fixed top-[-100%]'}>
