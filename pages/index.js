  ...
  return (
    ...
    <div className="flex text-center flex-col justify-center h-screen gap-10">
      ...
      <button className="animate-bounce flex self-center z-0">
        <Link href="#more"><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 13l-7 7-7-7m14-8l-7 7-7-7"></path></svg></Link>
      </button>
    </div>
